...
# User Added Constants: #TODO: possibly move these to a separate file
WLM_MAX_MEASUREMENT_RATE = 500  # Hz; Maximum Measurement Speed (the maximum number of frequency measurements per second)
...
ErrNoError = (
    2  # only with GetResultInfo, other functions return the measured value in this case
)
ErrNoValue = 0
ErrNoSignal = -1
ErrBadSignal = -2
